...
using SagaReferenceArchitecture.BuildingBlocks.Outbox.Factory;
...
using SagaReferenceArchitecture.BuildingBlocks.Outbox.Services;

namespace SagaReferenceArchitecture.BuildingBlocks.Outbox.Extensions;
